 ...
 * @version V1.0 
 */
package com.chinamap.core.util;
...
public class UserUtils {
	 ...
	 * @return
	 */
	public static Login getSubjectUser() {
		Login user = (Login) SecurityUtils.getSubject().getPrincipal();
		return user;
	}
	/**
	 * 
	 ...
	 */
	@Deprecated
	public static Login getSessionUser() {
		return (Login)getRequest().getSession().getAttribute("user");
	}
	 ...
	 */
	@Deprecated
	public static void setSessionUser(Login user) {
